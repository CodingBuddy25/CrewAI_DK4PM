...
async def DK_agent_company(company, focus,process, feedback):
    ...
    if len(feedback) > 1:
        DK_company_prompt = DK_company_prompt + "Also implement this feedback:" + feedback + "that is very important."
