...
async def DK_agent_company(company, focus,process):
    ...
    DK_company_prompt = f"You are a company expert. Search the internet for useful facts and suggestions that link the {company} in question to {focus} and the {process} process. Trey to find at least 20 references."
