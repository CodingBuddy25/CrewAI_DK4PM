...
async def DK_agent_process(company, focus,process,feedback):
    ...
    if len(feedback) > 1:
        DK_process_prompt = DK_process_prompt + "Also implement this feedback:" + feedback + "that is very important."
